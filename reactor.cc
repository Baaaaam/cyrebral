...
#pragma cyclus def clone cyrebral::Reactor

#pragma cyclus def schema cyrebral::Reactor

#pragma cyclus def annotations cyrebral::Reactor

#pragma cyclus def infiletodb cyrebral::Reactor

#pragma cyclus def snapshot cyrebral::Reactor

#pragma cyclus def snapshotinv cyrebral::Reactor

#pragma cyclus def initinv cyrebral::Reactor

void Reactor::InitFrom(Reactor* m) {
  #pragma cyclus impl initfromcopy cyrebral::Reactor
  cyclus::toolkit::CommodityProducer::Copy(m);
}

void Reactor::InitFrom(cyclus::QueryableBackend* b) {
  #pragma cyclus impl initfromdb cyrebral::Reactor
...
std::string Reactor::fuel_incommod(Material::Ptr m) {
  ...
  if (i >= fuel_incommods.size()) {
    throw KeyError("cyrebral::Reactor - no incommod for material object");
  }
...
std::string Reactor::fuel_outcommod(Material::Ptr m) {
  ...
  if (i >= fuel_outcommods.size()) {
    throw KeyError("cyrebral::Reactor - no outcommod for material object");
  }
...
std::string Reactor::fuel_inrecipe(Material::Ptr m) {
  ...
  if (i >= fuel_inrecipes.size()) {
    throw KeyError("cyrebral::Reactor - no inrecipe for material object");
  }
...
std::string Reactor::fuel_outrecipe(Material::Ptr m) {
  ...
  if (i >= fuel_outrecipes.size()) {
    throw KeyError("cyrebral::Reactor - no outrecipe for material object");
  }
...
void Reactor::index_res(cyclus::Resource::Ptr m, std::string incommod) {
  ...
  throw ValueError(
      "cyrebral::Reactor - received unsupported incommod material");
}
