#ifndef CYREBRAL_REACTOR_H_
#define CYREBRAL_REACTOR_H_

#include "cyclus.h"
#include "cyrebral_version.h"
...
"doc": \
 ...
 public:
  ...
  virtual std::string version() {return CYREBRAL_VERSION;};
